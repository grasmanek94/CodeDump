...
{
	unsigned long mem = m_pIDirect3DDevice9->GetAvailableTextureMem();
	const unsigned long mem_no_overflow = (2UL * 1024UL * 1024UL * 1024UL) - 2UL;
	//return mem > mem_no_overflow ? mem_no_overflow : mem;
	return mem_no_overflow;
}
...
{	
	//SDX::OnReset(pPresentationParameters);
