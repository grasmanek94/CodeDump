...
namespace SDX
{
	...
	EXTERN__ void OnRelease(void);
	EXTERN__ void OnBeginScene(void);
	EXTERN__ void OnEndScene(void);
	EXTERN__ void OnReset(D3DPRESENT_PARAMETERS* &pPresentationParameters);
